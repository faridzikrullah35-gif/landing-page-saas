...
export default function Header() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 md:px-10 py-4">
          ...
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <Image
              src="/header.png"
              alt="SaaSify Logo"
              width={32} // bisa diubah sesuai ukuran logo lu
              height={32}
              priority
            />
      ...
      {/* Mobile Dropdown */}
      {menuOpen && (
        <div className="fixed top-16 left-0 w-full bg-black/95 backdrop-blur-md p-6 flex flex-col space-y-4 text-center z-40 md:hidden">
          <Link href="/features" className="hover:text-orange-500 transition">Feature</Link>
